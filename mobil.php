<div class="card">
    <div class="card-header">
        <strong>Data Mobil Rental yang Tersedia</strong>
    </div> 
    
    <div class="card-body">
        <!-- <div class="col-md-12"> -->
        <form action="?page=mobil" method="POST">
            <div class=" input-group mb-3">
                <input type="text" class="form-control" placeholder="Masukan Nama Mobil..." name="keyword">
            ...
            <table class="table table-sm table-bordered table-hover m-0"> 
                ...
                <tbody> 
                    ...
                    if (isset($_POST['search'])) {
                        ...
                        if (!empty($keyword)) {
                            $query = mysqli_query($con, "SELECT * FROM mobil WHERE merek LIKE '%".$keyword."%'");
                        }
                    }
                    ...
                    ?>    
                        <tr>
                            ...
                            <td><img src="admin/file/<?php echo $data['gambar'] ?>" width="100"></td>
                        </tr>
                    <?php
                        $no++;
                    }
